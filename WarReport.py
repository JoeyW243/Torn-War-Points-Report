...
def process_torn_attacks(start_time, end_time):
    ...
    #  - Bonus Penalty Points (sum of -10 penalties),
    #  - Chain Bonus,
    #  - and Total Chain Points = Base Points + Bonus Penalties + Chain Bonus.
    ...
    # Build a DataFrame with points details.
